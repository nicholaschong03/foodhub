...
const NutritionAnalysisSchema = new Schema({
    ...
    vitamin_a: { type: Number, min: 0 },
    vitamin_c: { type: Number, min: 0 },
    vitamin_d: { type: Number, min: 0 },
...
const PostSchema = new Schema({
    ...
    nutritionAnalysis: { type: NutritionAnalysisSchema, default: undefined },
    ingredientsAnalysis: { type: [String], default: undefined },
    ...
    sentiment_score: { type: Number, default: undefined },
}, { timestamps: true });
