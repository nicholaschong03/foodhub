                ...
                {isSearching ? (
                  ...
                  <>
                    ...
                    {searchResults?.posts?.length > 0 && (
                      <div className="p-2">
                        <div className="text-xs font-semibold text-gray-500 px-2 py-1">Posts</div>
                        {searchResults.posts.map((post) => (
                          ...
                          >
                            ...
                            <div className="ml-3">
                              ...
                              <div className="text-xs text-gray-500">{post.menuItemName}</div>
                            </div>
                          </div>
                        ))}
                      </div>
                    ...
                    {!isLoadingMore && (hasMoreUsers || hasMorePosts) && (
                      <div className="p-4 text-center text-gray-500">Scroll for more results</div>
                    )}
                  </>
                )}
              </div>
