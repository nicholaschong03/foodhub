    ...
    <div className="w-full">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center gap-4 mb-4 mt-8 px-4 md:px-8">
        ...
        <div className="flex flex-row items-center gap-4 mt-4 md:mt-0 w-full flex-wrap">
          ...
          <span className="text-gray-700 text-base"><span className="font-bold">{user.followersCount || 0}</span> followers</span>
          <span className="text-gray-700 text-base"><span className="font-bold">{user.followingCount || 0}</span> following</span>
          <button
      ...
      {/* Post Details Modal */}
      {selectedPostId && (
        <PostDetailsModal postId={selectedPostId} onClose={() => setSelectedPostId(null)} currentUserId={userId} />
      )}
    </div>
  );
}